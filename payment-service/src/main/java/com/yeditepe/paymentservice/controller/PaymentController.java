...
public class PaymentController {
    ...
    public ResponseEntity<List<PaymentDTO>> getPaymentsByBooking(@PathVariable("bookingId") Long bookingId) {
    ...
    public ResponseEntity<PaymentDTO> getPaymentByTransaction(@PathVariable("transactionId") String transactionId) {
    ...
    public ResponseEntity<List<PaymentDTO>> getPaymentsByStatus(@PathVariable("status") PaymentStatus status) {
    ...
    public ResponseEntity<PaymentDTO> refundPayment(@PathVariable("paymentId") Long paymentId) {
